            ...
            <div class="dt-serv">
                <div class="serviciosTable">
                    <div class="cartaHeader d-flex justify-content-between align-items-center">
                        <h2 style="color: #009970;">Cargos</h2>
                    ...
                    <table id="Tabla_Datos" class="table mt-3">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <span class='btns btn-eliminar' data-bs-toggle='modal' data-bs-target='#venteliminar' onclick='ConfgVentElimCat(" . $fila['ID_Cargo'] . ");'>
                    ...
                    <form id="form-agregar" action="" method="post" class="forma">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="text-nivel" name="Nivel" class="form-select" required>

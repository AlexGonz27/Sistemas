    ...
    <div class="principal">
            ...
            <div class="dt-serv">
                <div class="serviciosTable">
                    <div class="cartaHeader d-flex justify-content-between align-items-center">
                        <h2 style="color: #009970;">Promociones</h2>
                    ...
                    <table id="Tabla_Datos" class="table mt-3">
                        ...
                        <tbody>
                            ...
                            <td>" . htmlspecialchars($fila['Descuento']) . "%</td>
                            <td>
                                ...
                                <span class='btns btn-eliminar' data-bs-toggle='modal' data-bs-target='#venteliminar' onclick='ConfgVentElimCat(" . $fila['ID_Promociones'] . ");'> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #009970;">
                        <h5 class="modal-title" id="modalLabel" style="color: white;">Agregar Promoción</h5>
                    ...
                    <form id="form-agregar" action="" method="post" class="forma">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="text-nombre" class="form-label">Tipo:</label>
                                <input id="text-nombre" name="nombre" type="text" class="form-control" placeholder="Tipo" required>
                            </div>

                            <div class="mb-3">
                                <label for="text-descrip" class="form-label">Descripción:</label>
                                <input id="text-descrip" name="descrip" type="text" class="form-control" placeholder="Descripción" required>
                            </div>

                            <div class="mb-3">
                                <label for="text-descuento" class="form-label">Descuento:</label>
                                <input id="text-descuento" name="descuento" type="text" class="form-control" placeholder="Descuento" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                            <button class="btn btn-primary" type="submit" style="background-color: #009970; border-color: #009970;">Agregar</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="ventmodifi" class="modal fade" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #009970;">
                        <h5 class="modal-title" id="modalLabel" style="color: white;">Modificar Promoción</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="form-modificar" action="" method="post" class="forma">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                            <button class="btn btn-primary" type="submit" style="background-color: #009970; border-color: #009970;">Modificar</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="venteliminar" class="modal fade" tabindex="-1" aria-labelledby="modalLabelEliminar" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #009970;">
                        <h5 class="modal-title" id="modalLabelEliminar" style="color: white;">Eliminar Promoción</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

    ...
    <div id="ventagregar" class="ventana">
        <div class="conte-vent">
            ...
            <form id="form-agregar" action="" method="post">
                ...
                <input id="text-cap" name="cap" type="numeric" placeholder="Capacidad">
                <input id="text-cost" name="cost" type="numeric" placeholder="Precio">
    ...
    <div id="ventmodifi" class="ventana">
        <div class="conte-vent">
            ...
            <form id="form-modificar"action="" method="post" name="modificar">
                ...
                <input id="text-costCat" name="cost" type="numeric" placeholder="Precio">
